                 ...
                 ${jsapiParamJson},//josn串
                   function (res)
                   {
					   if(res.err_msg=="edit_address:ok"){
						   ...
						   document.getElementById("editAddress").value=addr1+addr2+addr3+addr4;
			...
			<div class="col-md-12 col-xs-12">
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<div class="col-md-12 col-xs-12">
							<form action="<c:url value='/tmall/shopcart/pay.json'/>"
								...
								<input type="hidden" id="province" value="湖南" name="province">
