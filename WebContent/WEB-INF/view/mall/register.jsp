	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
				...
				<c:if test="${agentCode==null}">
					<h1 align="center">请重新扫推荐人的二维码进行注册!</h1>
				</c:if>
				<a align="center" href="<c:url value="/vmall/uc//dmz/slogin.html"/>">直接登录</a>
			...
			<div class="modal-content">
				<div class="modal-header">
					<%--<button type="button" class="close" data-dismiss="modal"--%>
						...
						<%--<span aria-hidden="true">&times;</span>--%>
					<%--</button>--%>
					<h4 class="modal-title" id="myModalLabel">注册成功,长按下面二维码关注公众号,进入商城</h4>
				</div>
				<div class="modal-body" id="alertMessageBody">
                    <%--<div class="container">--%>
                        <%--<div class="row">--%>
                            <%--<div class="col-md-12">--%>
                                <img class="img-responsive center-block" src="<c:url value="/resources/images/zmwsc.png"/>"/>
                        <%--</div>--%>
...
//															$("#myModal").modal({backdrop:"static",show:true});
															$("#scModal").modal({backdrop:"static",show:true});
...
//															$("#alertMessageBody").empty().html(m.message+",注册失败").addClass("text-danger");
															$("#myModalLabel").empty().html(m.message+",直接扫二维码登陆").addClass("text-danger");
															$("#scModal").modal({backdrop:"static",show:true});
														}
