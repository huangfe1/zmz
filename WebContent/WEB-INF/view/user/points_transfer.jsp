	...
	<form action="<c:url value='/points/transfer.json'/>"
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title text-primary" id="myModalLabel">代理积分转账</h4>
			</div>
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										disabled="disabled"
												...
												placeholder="输入转出数量">
												<c:if test="${pointsBalance<=0}">
													<span class="help-block text-danger">积分余额为0时无法转出</span>
												</c:if>
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-xs-12">
							<button type="submit" class="btn btn-success btn-block"
								...
								<span class="glyphicon glyphicon-save">&nbsp;</span>转让积分
							</button>
						</div>
					</div>
				</div>
