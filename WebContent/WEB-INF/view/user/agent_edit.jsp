		...
		<div class="modal-body">
			<div class="container-fluid">				
					...
					<ul class="nav nav-tabs" role="tablist">
						 ...
						 <li role="presentation"><a href="#authInfo" aria-controls="authInfo" role="tab" data-toggle="tab">产品授权</a></li>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="editName"
												...
												value="${ parameter.entity.topAgent ? '' : parameter.entity.parent.agentCode}" placeholder="输入上级代理编码">
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
							<!--特权商城编码-->
							<div class="form-group">
								<label for="editName" class="col-sm-2 control-label">特权商城上级</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="editTeqName"
										   tabIndex="10" name="teqparentAgentCode"
									<c:if test="${not user.admin}"> readonly='readonly' </c:if>
										   value="${ parameter.entity.topTeqAgent ? '' : parameter.entity.teqparent.agentCode}" placeholder="输入特权上级编码">
								</div>
								<div class="col-md-4 col-xs-4 text-error"></div>
							</div>
									<div class="form-group">
										...
										id="mainTable">
											<caption>
												<label>授权名称</label> <input type="text" value=""
													name="authName" id="authName" placeholder="授权名称"> <label>产品名称</label><input
									...
									<tbody>
										<c:forEach items="${parameter.entity.authorizations}"
											...
											<tr>
												...
												<td>
												<a class="btn btn-default viewBtn" target="letter" href="<c:url value='/auth/letter.html?id=${auth.id}'/>" data-id="${l.id}">查看证书</a>
