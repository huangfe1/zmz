		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
				...
				<form role="form" action="<c:url value='/agent/login.json' />"
						...
						<div class="row">
							<div class="col-md-8 col-xs-12">
								<input type="text" name="accountName" id="accountName"
									...
									placeholder="编号或者手机号" autofocus="autofocus" tabindex="1">
							</div>
						...
						<div class="row">
							<div class="col-md-8 col-xs-12">
								<input type="password" class="form-control input-lg" autocomplete="off"
									id="password" name="password" required placeholder="新用户为888888"
									tabindex="2">
							</div>
							<div class="col-md-4 col-xs-4 text-error"></div>
						</div>
					...
					<div class="form-group">
						<div class="row">
							<c:if test="${agentCode==null||agentCode==''}">
								<div class="col-md-12 col-xs-12">
						...
						<div class="col-md-6 col-xs-6">
								...
								href="<c:url value='/vmall/uc/dmz/register.html?url=${purl}'/>">
