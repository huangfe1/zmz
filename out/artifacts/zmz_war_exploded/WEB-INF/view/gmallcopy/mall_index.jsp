...
<body>
	...
	<div class="container" id="nav">
		<div class="row">
			...
			<div class="col-xs-3">
				<a class="thumbnail"
					href="<c:url value='/gmall/shopcart/index.html?ref=${agentCode}'/>"> <img
					data-src="" alt=""
					src="<c:url value='/resources/images/shopCart.jpg'/>"
					data-holder-rendered="true">
					<div class="caption">
						<h6 class="text-center">
							购物车<span class="badge" id="shopcartQuantity">${gshopcart.quantity}</span>
						</h6>
					</div>
				</a>
			</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			var query = function() {
				...
				var url="<c:url value='/dmz/gmall/goods/query.json'/>";
				$.getJSON("<c:url value='/dmz/gmall/goods/query.json'/>",param,
								function(datas) {
					var row=null;
...
/* 									start.val(parseInt(start.val())
			...
			$("#products").delegate(".detailBtn", "click", function(e) {
				...
				e.stopPropagation();
				var id=$(this).attr("data-id");
				window.location="<c:url value='/dmz/gmall/detail.html'/>"+"?id="+id;
			});
