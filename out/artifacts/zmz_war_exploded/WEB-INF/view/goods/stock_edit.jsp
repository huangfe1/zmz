	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<div class="container-fluid">
				<form action="<c:url value='/stock/edit.json'/>" name="editForm"
				...
				<div class="row">
					...
					<div class="panel panel-primary">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<p class="form-control-static">${stockBlotter.entity.goods.currentStock}</p>
								</div>
								<div class="col-md-4 col-xs-4 text-error"></div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<p class="form-control-static">${stockBlotter.entity.goods.currentPoint}</p>
								</div>
								<div class="col-md-4 col-xs-4 text-error"></div>
							</div>
							<div class="form-group">
